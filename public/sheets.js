...
function setUI() {
    for (let i = 0; i < 100; i++) {
        for (let j = 0; j < 26; j++) {
            ...
            let obj = document.querySelector(`div[rowid='${i}'][colid='${j}']`);
            obj.textContent = cellObject.value;
            ...
            if(cellObject.fontStyle.underline == true) {
                obj.style.textDecoration = "underline";
            } else {
                obj.style.textDecoration = "normal";
            }
            obj.style.textAlign = cellObject.textAlign;
        }
    }
}
